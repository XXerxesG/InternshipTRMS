...
class CreateCsadroptestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Csadroptests', function (Blueprint $table) {
            ...
            $table->text('tdifference')->nullable();
            ...
            $table->text('fourthdropposition')->nullable();
            $table->text('fifthdropposition')->nullable();
