...
<div class="container" id="root">
	...
	<form action="/testtype/flexings" method="POST">
		{{ method_field('patch') }}
		{{ csrf_field() }}
	...
	<div id="section4">
		...
		<form action="/testtype/flexing" method="POST">
			{{ method_field('patch')}}
			{{ csrf_field() }}
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="text" name="tto[{{$i}}][0]" value="{{ $datas[$i]->{'8000'} }}"></td>
							<td><input type="text" name="tto[{{$i}}][1]" value="{{ $datas[$i]->{'16000'} }}"></td>
							<td><input type="text" name="tto[{{$i}}][2]" value="{{ $datas[$i]->{'24000'} }}"></td>
							<td><input type="text" name="tto[{{$i}}][3]" value="{{ $datas[$i]->{'32000'} }}"></td>
							<td><input type="text" name="tto[{{$i}}][4]" value="{{ $datas[$i]->{'40000'} }}"></td>
							<td><input type="text" name="tto[{{$i}}][5]" value="{{ $datas[$i]->{'48000'} }}"></td>
							<td><input type="text" name="tto[{{$i}}][6]" value="{{ $datas[$i]->{'56000'} }}"></td>
							<td><input type="text" name="tto[{{$i}}][7]" value="{{ $datas[$i]->{'65000'} }}"></td>
						</tr>
						@endfor
					</tbody>
				</table>
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							<th>{{ $i+1 }}</th>
							{{-- tto refers to Test-Type-Object --}}
							<td><input type="text" name="tto[{{$i}}][8]" value="{{ $datas[$i]->station_num }}"></td>
							<td><input type="text" name="tto[{{$i}}][9]" value="{{ $datas[$i]->EWBC }}"></td>
							<td><input type="text" name="tto[{{$i}}][10]" value="{{ $datas[$i]->LONW1 }}"></td>
							<td><input type="text" name="tto[{{$i}}][11]" value="{{ $datas[$i]->LONW2 }}"></td>
							<td><input type="text" name="tto[{{$i}}][12]" value="{{ $datas[$i]->BM }}"></td>
							<td><input type="text" name="tto[{{$i}}][13]" value="{{ $datas[$i]->fire }}"></td>
							<td><input type="text" name="tto[{{$i}}][14]" value="{{ $datas[$i]->EOIW }}"></td>
							<td><input type="text" name="tto[{{$i}}][15]" value="{{ $datas[$i]->EPM }}"></td>
							<td><input type="text" name="tto[{{$i}}][16]" value="{{ $datas[$i]->LONW3 }}"></td>
							<td><input type="text" name="tto[{{$i}}][17]" value="{{ $datas[$i]->result }}"></td>
							<td><input type="text" name="tto[{{$i}}][18]" value="{{ $datas[$i]->remark }}"></td>
						</tr>
						@endfor
					</tbody>
				</table>
	...
	<div id="section7">
		...
		<form action="/testtype/flexingss" method="POST">
			{{ method_field('patch') }}
			{{ csrf_field() }}
