...
{{--start making changes here--}}
	<div id="section4">
		...
		<p>Description: To simulate conditions during transportation where the appliance in packaging may be damaged or exposed.</p>
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td>{{ $datas[$i]->{'type_of_vibration'} }}</td>
							<td>{{ $datas[$i]->{'F-Box'} }}</td>
							<td>{{ $datas[$i]->{'iron'} }}</td>
