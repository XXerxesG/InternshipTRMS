...
<div class="" id="root" style="padding-left: 1%;padding-right=2%">
	<h3>Test & Verification Laboratory</h3>
	<h5>Test Request Form</h5>
	<form method="post" action="/tickets" class="form-inline">
		{{ csrf_field() }}
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<select name="project_name" id="" class="form-control" v-model="project_name" @change="populate" required>
		...
		<div class="row">
			<div class="col-md-3">
				<div class="form-group">
					...
					<input type="hidden" class="form-control" disabled :value="weekcode" name="weeknumber">
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
					<label for="">Project Manager:</label><br>
					<input type="text" class="form-control" disabled v-model="project_manager">
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
					<label for="">Cost Code:</label><br>
					<input type="text" class="form-control" disabled v-model="charging_code">
				</div>
			</div>
		...
		<table class="table">
			<thead>
				<tr>
					...
					<td>Protocal Deviation?<br> (If yes, please specify)<span style="color: red">*</span></td>
		...
		<span @click="removeTest()" style="color: red;text-decoration: underline; cursor: pointer;padding-left:90%">Remove Test</span>
		<hr>
		...
		<div class="text-center">
			<div class="form-group">
				...
				<input type="button" class='btn btn-danger' value="Clear Input" @click="window.location.reload()">
			</div>
		</div>
